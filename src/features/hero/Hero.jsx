...
const Hero = () => {
  ...
  return (
    <div className='relative h-full w-full overflow-hidden pt-28 lg:pt-50 bg-primary pb-16 lg:pb-0 px-6 md:px-16 xl:px-28'>
      {/* Centered Max-Width Content Wrapper */}
      <div className='mx-auto max-w-[1280px] w-full flex flex-col-reverse lg:flex-row gap-12 lg:gap-0'>
        
        {/* Left Container */}
        <div ref={leftRef} className="left flex flex-col items-start w-full lg:w-[58%] h-full">
            <div className='flex items-center text-white bg-transparent-pill/10 px-4 py-2 rounded-full border border-transparent-pill/10 uppercase font-nav font-light text-[11px] tracking-[3px] mb-8'>
            ...
            <div className='font-hero text-5xl md:text-6xl lg:text-7xl xl:text-[88px] 2xl:text-[104px] leading-tight md:leading-[70px] lg:leading-[80px] xl:leading-[95px] 2xl:leading-[110px] font-semibold text-transparent bg-clip-text bg-linear-to-r from-[#f4f8f9] to-[#97ddf4]'>
              Engineering 
            </div>
            <div className='font-hero text-5xl md:text-6xl lg:text-7xl xl:text-[88px] 2xl:text-[104px] leading-tight md:leading-[70px] lg:leading-[80px] xl:leading-[95px] 2xl:leading-[110px] font-semibold text-transparent bg-clip-text bg-linear-to-r from-[#f4f8f9] to-[#97ddf4]'>
              Digital 
            </div>
            <div className='font-hero text-5xl md:text-6xl lg:text-7xl xl:text-[88px] 2xl:text-[104px] leading-tight md:leading-[70px] lg:leading-[80px] xl:leading-[95px] 2xl:leading-[110px] font-semibold text-transparent italic bg-clip-text bg-linear-to-r from-[#84e2fa] via-[#9dd7f7] to-[#b2a0fe]'>
              Experiences
            </div>
            ...
            <div className='flex flex-col sm:flex-row gap-3 mt-5 text-sm font-nav font-medium items-start sm:items-center w-full'>
                <button 
                        className='bg-white flex gap-2 rounded-full py-3 px-4 sm:px-6 w-full sm:w-fit justify-center items-center cursor-pointer whitespace-nowrap'
                ...
                <button 
                  className='flex gap-3 text-white items-center justify-center whitespace-nowrap border border-white/10 rounded-full bg-white/5 py-3 px-4 sm:px-6 w-full sm:w-fit cursor-pointer tracking-widest'
        ...
        {/* Right Container */}
        <div ref={rightRef} className="right will-change-transform w-full lg:w-[42%] h-full relative flex justify-center lg:justify-start lg:pl-10">
          <motion.div 
            animate={{rotate:360}}
            transition={{
              duration: 20,
          ...
          <motion.div 
            ...
            '
          >
            <div className="relative profile w-full h-[340px] lg:w-85.25 lg:h-108 lg:m-5 rounded-3xl lg:rounded-4xl overflow-hidden">
                <img 
            ...
            <div className="description w-full flex justify-between items-start px-2 md:px-0 mt-2 md:mt-0">
              ...
              <div className="right flex flex-col gap-2 md:gap-1 font-nav text-[10px] text-white/50 items-end lg:mr-7 -mt-2">
